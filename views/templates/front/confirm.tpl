...
{capture name=path}<a href="{$GC_Link}">{l s='Your shopping cart' mod='gcheckout'}</a><span class="navigation-pipe">
{$navigationPipe}</span>{l s='Google Checkout' mod='gcheckout'}{/capture}
...
<p>
	<img src="{$modules_dir}./gcheckout/gcheckout.gif" alt="{l s='Google Checkout' mod='gcheckout'}" style="margin-bottom: 5px" />
